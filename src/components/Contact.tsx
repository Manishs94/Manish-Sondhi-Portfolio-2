          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 h-full">
              <motion.form
                ...
                className="bg-white dark:bg-gray-700 p-8 rounded-xl shadow-sm space-y-6 h-full flex flex-col"
              >
                <div>
                ...
                <div className="flex-grow">
                  ...
                  <textarea
                    ...
                    } bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none h-full`}
                  />
                  {errors.message && (
